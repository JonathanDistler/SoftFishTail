...
#uses the Dynamixel Class implement by Matthew. Also, uses a hard-flush at the end, rather than the soft-flush previously implemented. Given Mattew's Class setup, this file needs to be one folder below the combinedplatform, camera, and force-serial comm test scripts

#######Write desired frequency below #################
desiredFreq=0.2
######################################################
