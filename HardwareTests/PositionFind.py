...
#goal is to determine the goal position, the two positions on the circle parallel to the tail. 
#This script is similar to Matthew's Dynamixel class, but it has a much smaller use-case. In short, it uses the dynamixel motor datasheets to encode address positions, then it exhibits the user command to move to a certain position (such as the start position), so they can accurately tension the fish
goal_pos=1238
goal_vel=100
