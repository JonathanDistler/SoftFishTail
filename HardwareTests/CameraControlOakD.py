...
output_folder = r"C:\Users\15405\OneDrive\Desktop\Career\ETHZ\ETHZ Work\FishTestOutputRaw"
freq = 2.0

output_path = os.path.join(output_folder, f"output_{freq}.avi")

# Define absolute paths for sync files
signal_dir = r"C:\Users\15405\OneDrive\Desktop\Career\ETHZ\ETHZ Work\Dynamixel_Control\softFish\CombinedTesting"
